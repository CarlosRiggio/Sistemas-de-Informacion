...
BEGIN
    ...
    -- 3.
    IF ( (nuevoEstado != "Abierto") AND (nuevoEstado != "cerrado") AND (nuevoEstado != "Finalizado") ) THEN
    ...
    IF ( (SELECT estado_evento FROM Evento WHERE (
        ...
        UPDATE Evento SET estado_evento = nuevoEstado WHERE nombre_espectaculo_evento = nombre_espectaculo_IN AND nombre_recinto_evento=nombre_recinto_IN AND fecha_evento=fecha_evento_IN;
    ELSE 
